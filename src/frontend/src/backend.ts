...
import type { Bet as _Bet, BetId as _BetId, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getRoomState(arg0: string): Promise<GameRoom> {
        if (this.processError) {
            try {
    ...
    async joinRoom(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateRoom(arg0: string, arg1: Array<bigint>, arg2: string, arg3: boolean): Promise<string> {
        if (this.processError) {
            try {
...
function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Bet>): Array<Bet> {
